...
public class PerfectMargarita extends ListActivity {
	...
	private class MyAdapter extends ArrayAdapter<String> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			String[] items = getResources().getStringArray(R.array.perfect_margarita);
			...
			if (position == 0){
				iv.setImageResource(R.drawable.perfect_margarita);
			}
			else if ( position == 1 ){
