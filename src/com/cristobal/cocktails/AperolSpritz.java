...
public class AperolSpritz extends ListActivity {
	...
	private class MyAdapter extends ArrayAdapter<String> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			String[] items = getResources().getStringArray(R.array.aperol_spritz);
			...
			if (position == 0){
				iv.setImageResource(R.drawable.aperol_spritz);
			}
			else if ( position == 1 ){
